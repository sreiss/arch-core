...
angular.module('archCore')
  .constant('i18nfrFRConstant', {
    ...
    'HOME_P2' : "(1) « Correctement marqué » signifie que les coureurs reçoivent une information suffisante pour effectuer le parcours sans se perdre.Cela inclut un marquage physique (fanions, rubalises, autre signalétique…) ou le marquage permanent d’un sentier de randonnée ou une trace GPS ou des indications sur une carte.(2) « Autosuffisance ou semi autosuffisance » signifie que le coureur doit être autonome entre les points de ravitaillement, en ce qui concerne l’habillement, les communications, la nourriture et la boisson.",
    'USERS_TITLE' : "Membres",
